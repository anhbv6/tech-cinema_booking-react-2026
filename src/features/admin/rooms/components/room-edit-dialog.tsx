...
import {
  ...
  roomTypes,
  type RoomFormValues,
} from "@/features/admin/rooms/schemas/room.schema";
import type { Room } from "@/features/admin/rooms/components/room-table";
...
export function RoomEditDialog({
  ...
  const updateRoomMutation = useMutation({
    ...
    onError: (error: unknown) => {
      const message = (error as { response?: { data?: { message?: string } } })?.response?.data?.message || "Failed to update room";
      toast.error(message);
    },
  });
