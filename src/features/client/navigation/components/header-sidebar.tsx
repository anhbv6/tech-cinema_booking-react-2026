...
import { clientNavItems } from "@/features/client/navigation/config";
import { Bell, ChevronDown, LogOut, Search, Settings, Star, User } from 'lucide-react';
    ...
    <header className="flex h-16 flex-1 items-center justify-between border-b border-slate-100 bg-white px-12">
      ...
      <NavigationMenu>
        <NavigationMenuList className="gap-8">
          {(clientNavItems as ClientNavItem[]).map((item) => {
